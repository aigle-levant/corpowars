...
const columns = [
  {
    title: "Features",
    links: ["Leaderboard", "About", "Dashb", "Changelog", "Roadmap"],
  },
  {
    title: "Player",
    links: ["Profile", "Settings", "Companies", "Backpack"],
  },
  {
    title: "Resources",
    links: [
      ...
      <footer className="mx-auto w-full max-w-6xl">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-3 md:grid-cols-6">
          <div className="col-span-2 sm:col-span-3 md:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-foreground">
              Line must go up, everything else secondary.
            </p>
        ...
        <div className="flex flex-col-reverse items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-muted-foreground">
            ...
            Corpowars Inc. All rights reserved.
          </p>
